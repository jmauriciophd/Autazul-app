        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-muted-foreground text-center md:text-left">
              © {new Date().getFullYear()} Autazul. Todos os direitos reservados.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-4 text-sm">
              <button
                onClick={() => window.location.href = 'mailto:webservicesbsb@gmail.com'}
          ...
          <ScrollArea className="h-[70vh] pr-4">
            <div className="space-y-6 text-sm">
              ...
              <section>
                ...
                <p className="text-muted-foreground mt-2">
                  Para exercer seus direitos, entre em contato: <a href="mailto:webservicesbsb@gmail.com" className="text-primary hover:underline">webservicesbsb@gmail.com</a>
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground mt-2">
                  <strong>E-mail:</strong> <a href="mailto:webservicesbsb@gmail.com" className="text-primary hover:underline">webservicesbsb@gmail.com</a>
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground mt-2">
                  <strong>E-mail de Suporte:</strong> <a href="mailto:webservicesbsb@gmail.com" className="text-primary hover:underline">webservicesbsb@gmail.com</a>
                </p>
              </section>
            </div>
          </ScrollArea>
          <div className="flex justify-end pt-4">
            <Button onClick={() => setPrivacyOpen(false)}>Fechar</Button>
          </div>
        </DialogContent>
      </Dialog>
          ...
          <ScrollArea className="h-[70vh] pr-4">
            <div className="space-y-6 text-sm">
              <section>
                ...
                <p className="text-muted-foreground">
                  Ao criar uma conta e utilizar a plataforma <strong>Autazul</strong>, você concorda com estes Termos de Uso. Se você não concordar com qualquer parte destes termos, não deverá utilizar nossos serviços.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  O Autazul é uma plataforma digital que permite pais e responsáveis acompanharem eventos e comportamentos de crianças autistas, com a colaboração de profissionais de saúde e educação. O serviço inclui:
                </p>
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  Para utilizar o Autazul, você deve:
                </p>
                <ul className="list-disc pl-6 space-y-1 text-muted-foreground mt-2">
              ...
              <section>
                ...
                <p className="text-muted-foreground mt-3 mb-2"><strong>4.2 Você NÃO deve:</strong></p>
                <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  Profissionais cadastrados na plataforma devem:
                </p>
                <ul className="list-disc pl-6 space-y-1 text-muted-foreground mt-2">
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  <strong>IMPORTANTE:</strong> O Autazul é uma ferramenta de acompanhamento e registro. NÃO somos:
                </p>
                <ul className="list-disc pl-6 space-y-1 text-muted-foreground mt-2">
